...
function setup() {
  ...
  box9 = new Box(700, 500, 70, 70);
  box10 = new Box(700, 450, 70, 70);
  box11 = new Box(700, 400, 70, 70);
  box12 = new Box(700, 350, 70, 70);
  box13 = new Box(700, 300, 70, 70);
  box14 = new Box(700, 250, 70, 70);
  box15 = new Box(700, 200, 70, 70);
  box16 = new Box(800, 600, 70, 70);
  box17 = new Box(800, 550, 70, 70);
  box18 = new Box(800, 500, 70, 70);
  box19 = new Box(800, 450, 70, 70);
  box20 = new Box(800, 400, 70, 70);
  box21 = new Box(900, 350, 70, 70);
